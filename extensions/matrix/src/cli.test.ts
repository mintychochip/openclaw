...
describe("matrix CLI verification commands", () => {
  ...
  it("prunes stale matrix gateway devices", async () => {
    ...
    expect(pruneMatrixStaleGatewayDevicesMock).toHaveBeenCalledWith({ accountId: "poe", cfg: {} });
  ...
  it("resets the Matrix room-key backup when confirmed", async () => {
    ...
    expect(resetMatrixRoomKeyBackupMock).toHaveBeenCalledWith({ accountId: "default", cfg: {} });
